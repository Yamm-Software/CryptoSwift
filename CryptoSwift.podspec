Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/Yamm-Software/CryptoSwift"
  s.license      = {:type => "Attribution License", :file => "LICENSE"}
  s.source       = { :git => "https://github.com/Yamm-Software/CryptoSwift.git", :tag => "#{s.version}" }
